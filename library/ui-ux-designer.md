...
## 최신 지식 (2026-07-27)
**🆕 오늘 웹리서치 (2026-07-27):**
- **GenUI 주류화**: 생성형 UI가 사용자 의도에 맞춰 실시간 인터페이스 재조립 — 사전제작 화면→모듈형 컴포넌트 시스템으로 이동 (uxpin.com, stan.vision)
- **채택률**: 디자이너 93%가 생성형 AI 사용, 73%가 'AI 협업'을 올해 최대 임팩트로 지목. 역할=창작자→큐레이터 전환 (agencypartner.com)
- **3대 수렴 축**: 적응형·생성형 AI + 마찰없는 개인화 + 접근성·프라이버시 기본값화 (branex.com)
